...
export function toMovementServiceRecord(service: MovementService): MovementServiceRecord {
  return {
    ...
    serviceReceiverOrganizationId: service.serviceReceiverOrganizationId,
    billToOrganizationId: service.billToOrganizationId,
    payerOrganizationId: service.payerOrganizationId,
